TokoVoipConfig = {
	...
	distance = {
		...
		25, -- Shout speech distance in gta distance units
	},
	...
	keySwitchChannels = Keys["PAGEUP"], -- Keybind used to switch the radio channels
	keySwitchChannelsSecondary = Keys["PAGEDOWN"], -- If set, both the keySwitchChannels and keySwitchChannelsSecondary keybinds must be pressed to switch the radio channels
	...
	plugin_data = {
		...
		TSPassword = "comandorjpamonha", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "[TokoVOIP] Aguardando", -- You NEED tokovoip in the wait channel name!

		-- Blocking screen informations
		TSServer = "131.196.199.81:9129", -- TeamSpeak server address to be displayed on blocking screen
		...
		localName = "Comando RJ", -- If set, this name will be used as the user's teamspeak display name
