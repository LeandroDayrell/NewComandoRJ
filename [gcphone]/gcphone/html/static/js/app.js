webpackJsonp([0], [, , , , , , function (t, e, n) {
	...
	e.a = {
		...
		CreateTextModal: function () {
			var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
			return ! 1 === l.a.getters.useMouse ? p.a.getReponseText(t) : new o.a(function (e, n) {
...
function (t, e, n) {
	...
	A = function () {
			...
			value: function () {
				...
				var e = h()(c.a.mark(function t() {
					...
					return c.a.wrap(function (t) {
						for (;;) switch (t.prev = t.next) {
						case 0:
							return w.a.commit("SET_TEMPO_HIDE", !0),
							t.next = 3,
							this.post("takePhoto", {
				...
				var e = h()(c.a.mark(function t() {
					...
					return c.a.wrap(function (t) {
						...
						case 0:
							...
							return t.next = 3,
							window.jQuery.get("/html/static/config/config.json");
						case 3:
							e = t.sent,
							this.config = JSON.parse(e),
							!0 === this.config.useWebRTCVocal && (this.voiceRTC = new C.a(this.config.RTCConfig), T = !0),
			...
			value: function () {
				...
				var e = h()(c.a.mark(function t(e) {
					...
					return c.a.wrap(function (t) {
						...
						case 3:
							return n = t.sent,
							t.abrupt("return", this.post("startCall", {
								numero: e,
								rtcOffer: n,
								extraData: s
							}));
				...
				var e = h()(c.a.mark(function t(e) {
					...
					return c.a.wrap(function (t) {
						...
						case 0:
							...
							return t.next = 3,
							this.voiceRTC.acceptCall(e);
						case 3:
							return n = t.sent,
							t.abrupt("return", this.post("acceptCall", {
								infoCall: e,
								rtcAnswer: n
							}));
						case 7:
		...
		},
		{
			key: "onwaitingCall",
			value: function (t) {
				w.a.commit("SET_APPELS_INFO_IF_EMPTY", o()({},
				t.infoCall, {
		...
		},
		{
			key: "onacceptCall",
			value: function (t) {
				var e = this; ! 0 === T && (!0 === t.initiator && this.voiceRTC.onReceiveAnswer(t.infoCall.rtcAnswer), this.voiceRTC.addEventListener("onCandidate", function (n) {
					e.post("onCandidates", {
						id: t.infoCall.id,
						candidates: n
					})
...
, , , , , , , , , , , , , , , , , , , function (t, e, n) {
	...
	u = {
		install: function (t) {
			if (!this.installed) {
				this.installed = !0,
				i.a.component("notification", r.a);
				var e = function (t) {
					c.a.$emit("add",t)
				};
				i.a.notify = e,
...
function (t, e, n) {
	...
	f = 365 * l,
	d = {
		pt_BR: ["agora", ["%s segundo atrás", "%s segundos atrás"], ["%s minuto atrás", "%s minutos atrás"], ["%s hora atrás", "%s horas atrás"], ["%s dia atrás", "%s dias atrás"], ["%s semana atrás", "%s semanas atrás"], ["%s mês atrás", "%s meses atrás"], ["%s ano atrás", "%s anos atrás"]]
	}
},
function (t, e, n) {
	"use strict";
...
function (t, e, n) {
	...
	v = function () {
				...
				var e = l()(c.a.mark(function t() {
					return c.a.wrap(function (t) {
						...
						case 0:
							...
							this.close();
						case 2:
							return this.myPeerConnection = new RTCPeerConnection(this.RTCConfig),
							t.next = 5,
		...
		},
		{
			key: "close",
			value: function () {
				null !== this.myPeerConnection && this.myPeerConnection.close(),
				this.myPeerConnection = null
			}
		},
		{
			...
			value: function () {
				...
				var e = l()(c.a.mark(function t(e) {
					...
					return c.a.wrap(function (t) {
						for (;;) switch (t.prev = t.next) {
						case 0:
							return n = JSON.parse(atob(e.rtcOffer)),
							this.newConnection(),
							this.initiator = !1,
							t.next = 5,
							navigator.mediaDevices.getUserMedia(m);
						case 5:
							return this.stream = t.sent,
							this.myPeerConnection.onicecandidate = this.onicecandidate.bind(this),
							this.myPeerConnection.addStream(this.stream),
		...
		},
		{
			...
			value: function (t) {
				if (void 0 !== t.candidate && (this.myCandidates.push(t.candidate), void 0 !== this.listener.onCandidate)) {
					...
					i = void 0;
					try {
						for (var a, r = o()(this.listener.onCandidate); ! (n = (a = r.next()).done); n = !0) { (0, a.value)(e)
						}
					} catch(t) {
						s = !0,
						i = t
...
function (t, e, n) {
	...
	c = {
		...
		ignoreCall: function (t) { (0, t.commit)("SET_APPELS_INFO", null)
		},
		appelsDeleteHistorique: function (t, e) {
			...
			n("SET_APPELS_HISTORIQUE", s.appelsHistorique.filter(function (t) {
				return t.num !== o
			}))
		},
		appelsDeleteAllHistorique: function (t) {
			...
			e("SET_APPELS_HISTORIQUE", [])
		},
		resetAppels: function (t) {
			var e = t.commit;
			e("SET_APPELS_HISTORIQUE", []),
			e("SET_APPELS_INFO", null)
		}
	},
	u = {
		...
		SET_APPELS_INFO_IS_ACCEPTS: function (t, e) {
			null !== t.appelsInfo && (t.appelsInfo = o()({},
			t.appelsInfo, {
				is_accepts: e
			}))
		}
...
function (t, e, n) {
	...
	i = {
		resetBourse: function (t) { (0, t.commit)("SET_BOURSE_INFO", [])
		}
	},
	a = {
...
function (t, e, n) {
	...
	c = {
		...
		resetContact: function (t) { (0, t.commit)("SET_CONTACTS", [])
		}
	},
	u = {
...
function (t, e, n) {
	...
	a = {
		setMessages: function (t, e) { (0, t.commit)("SET_MESSAGES", e)
		},
		...
		deleteMessagesNumber: function (t, e) {
			...
			n("SET_MESSAGES", o.messages.filter(function (t) {
		...
		setMessageRead: function (t, e) {
			var n = t.commit;
			s.a.setMessageRead(e),
			n("SET_MESSAGES_READ", {
				num: e
			})
		},
		resetMessage: function (t) { (0, t.commit)("SET_MESSAGES", [])
		}
	},
	r = {
...
function (t, e, n) {
	...
	g = {
			...
			return c()(a.a.mark(function t() {
				...
				return a.a.wrap(function (t) {
					...
					case 0:
						...
						d.a.getConfig();
					case 2:
						for (o = t.sent, i = h()(o.language), r = !0, c = !1, u = void 0, t.prev = 7, p = l()(i); ! (r = (m = p.next()).done); r = !0) v = m.value,
						void 0 !== (g = o.language[v].TIMEAGO) && f.a.prototype.$timeago.addLocale(v, g);
						t.next = 15;
						break;
					case 11:
						t.prev = 11,
					...
					case 23:
						...
						void 0 !== o.defaultContacts && n("SET_DEFAULT_CONTACTS", o.defaultContacts),
						n("SET_CONFIG", o);
					case 26:
					case "end":
						return t.stop()
		...
		setVisibility: function (t, e) { (0, t.commit)("SET_PHONE_VISIBILITY", e)
		},
		setZoon: function (t, e) {
			var n = t.commit;
			window.localStorage.gc_zoom = e,
			n("SET_ZOOM", e)
		},
		...
		setCoque: function (t, e) {
			var n = t.commit;
			window.localStorage.gc_coque = o()(e),
			n("SET_COQUE", e)
		},
		setVolume: function (t, e) {
			var n = t.commit;
			window.localStorage.gc_volume = e,
			n("SET_VOLUME", e)
		},
	...
	p = {
		...
		tchatAddMessage: function (t, e) {
			...
			void 0 !== n.channels.find(function (t) {
				return t.channel === a
			}) && (null !== c && (c.pause(), c = null), c = new Audio("/html/static/sound/tchatNotification.ogg"), c.volume = o.volume, c.play()),
			s("TCHAT_ADD_MESSAGES", {
				message: i
			})
		},
		tchatAddChannel: function (t, e) { (0, t.commit)("TCHAT_ADD_CHANNELS", {
				channel: e.channel
			})
		},
		tchatRemoveChannel: function (t, e) { (0, t.commit)("TCHAT_REMOVES_CHANNELS", {
				channel: e.channel
			})
		},
...
function (t, e, n) {
	...
	u = {
		...
		addTweet: function (t, e) {
			var n = t.commit,
			s = t.state,
			o = 0 === s.twitterNotification || 1 === s.twitterNotification || 2 === s.twitterNotification;
			n("ADD_TWEET", {
				tweet: e
			})
		},
		...
		setTwitterNotificationSound: function(t,e){
			...
			n("SET_TWITTER_NOTIFICATION_SOUND",{
				notificationSound: e
			})
		}
	},
...
default = {
		...
		mounted: function () {
			...
			window.addEventListener("keyup", function (e) { - 1 !== ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown", "Backspace", "Enter"].indexOf(e.key) && t.$bus.$emit("keyUp" + e.key),
				...
				return c()(o.a.mark(function n() {
					...
					return o.a.wrap(function (n) {
						...
						case 0:
							...
							s.duration),
							null !== e.sound && void 0 !== e.sound && (i = new Audio("/html/static/sound/" + e.sound), i.addEventListener("ended", function () {
								i.src = null
							}), i.play());
						case 4:
						case "end":
			...
			loadItems: function () {
				...
				return c()(o.a.mark(function e() {
					...
					return o.a.wrap(function (e) {
						...
						case 0:
							return s = "https://9gag.com/v1/group-posts/group/default/type/hot?" + t.nextCursor,
							e.next = 3,
							fetch(s);
						case 3:
							return i = e.sent,
...
default = {
		...
		computed: o()({},
		n.i(i.b)(["IntlString", "useMouse", "themeColor"]), {
			subMenu: function () {
				return [{
					Comp: u.a,
		...
		methods: {
			...
			onBackspace: function () { ! 0 !== this.ignoreControls && this.$router.push({
					name: "home"
				})
			}
		},
...
default = {
		...
		methods: o()({},
		n.i(i.a)(["acceptCall", "rejectCall", "ignoreCall"]), {
		...
		computed: o()({},
		n.i(i.b)(["IntlString", "backgroundURL", "useMouse", "appelsInfo", "appelsDisplayName", "appelsDisplayNumber", "myPhoneNumber"]), {
		...
		created: function () {
			this.useMouse || (this.$bus.$on("keyUpEnter", this.onEnter), this.$bus.$on("keyUpArrowLeft", this.onLeft), this.$bus.$on("keyUpArrowRight", this.onRight)),
		...
		beforeDestroy: function () {
			...
			this.$bus.$off("keyUpArrowLeft", this.onLeft),
			this.$bus.$off("keyUpArrowRight", this.onRight),
			void 0 !== this.intervalNum && window.clearInterval(this.intervalNum),
			this.$phoneAPI.setIgnoreFocus(!1)
		}
	}
},
		...
		n.i(r.b)(["IntlString", "contacts"]), {
			contactsList: function () {
				return [{
					...
					return t.backgroundColor = n.i(c.a)(t.number),
					t
				})))
			}
		}),
...
default = {
		...
		methods: {
			onSelect: function (t) {
				var e = this; ! 0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({
...
default = {
		...
		n.i(i.a)(["startCall"]), {
			...
			onBackspace: function () { ! 0 !== this.ignoreControls && (0 !== this.numero.length ? this.numero = this.numero.slice(0, -1) : history.back())
			},
...
default = {
		...
		methods: l()({},
		n.i(p.a)(["startCall", "appelsDeleteHistorique", "appelsDeleteAllHistorique"]), {
				...
				return c()(o.a.mark(function n() {
					...
					return o.a.wrap(function (n) {
						...
						case 7:
							...
							e.ignoreControls = !1,
							n.t0 = c.id,
							n.next = 0 === n.t0 ? 12 : 1 === n.t0 ? 14 : 2 === n.t0 ? 16 : 17;
							break;
						case 12:
							return e.startCall({
								numero:
		...
		computed: l()({},
		n.i(p.b)(["IntlString", "useMouse", "appelsHistorique", "contacts"]), {
			historique: function () {
				var t = n.i(h.b)(this.appelsHistorique, "num"),
				e = [];
				for (var s in t) {
					var o = t[s],
					i = o.map(function (t) {
						return t.date = new Date(t.time),
						t
					}).sort(function (t, e) {
					...
					e.push({
						...
						backgroundColor: a.backgroundColor || n.i(h.a)(s),
						icon: a.icon
					})
				}
...
default = {
		...
		computed: o()({},
		n.i(i.b)(["IntlString", "useMouse", "bourseInfo"])),
		methods: {
			scrollIntoViewIfNeeded: function () {
				var t = this;
				this.$nextTick(function () {
			...
			onUp: function () {
				this.currentSelect = 0 === this.currentSelect ? 0 : this.currentSelect - 1,
		...
		created: function () {
			this.useMouse || (this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp)),
			this.$bus.$on("keyUpBackspace", this.onBackspace)
		},
		beforeDestroy: function () {
			this.$bus.$off("keyUpArrowDown", this.onDown),
...
default = {
		...
		computed: o()({},
		n.i(i.b)(["IntlString", "useMouse", "nbMessagesUnread", "backgroundURL", "messages", "AppsHome", "warningMessageCount"])),
		methods: o()({},
		n.i(i.a)(["closePhone", "setMessages"]), {
			onLeft: function () {
		...
		created: function () {
			this.useMouse ? this.currentSelect = -1 : (this.$bus.$on("keyUpArrowLeft", this.onLeft), this.$bus.$on("keyUpArrowRight", this.onRight), this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter)),
...
default = {
		...
		methods: {
			...
			onUp: function () { ! 0 !== this.disable && (this.currentSelect = 0 === this.currentSelect ? this.list.length - 1 : this.currentSelect - 1, this.scrollIntoViewIfNeeded())
			},
			onDown: function () { ! 0 !== this.disable && (this.currentSelect = this.currentSelect === this.list.length - 1 ? 0 : this.currentSelect + 1, this.scrollIntoViewIfNeeded())
			},
			selectItem: function (t) {
				this.$emit("select", t)
			},
			...
			onRight: function () { ! 0 !== this.disable && this.$emit("option", this.list[this.currentSelect])
			},
			onEnter: function () { ! 0 !== this.disable && this.$emit("select", this.list[this.currentSelect])
			}
		},
		created: function () {
...
default = {
		...
		created: function () {
			this.useMouse ? this.currentSelect = -1 : (this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter)),
...
default = {
		...
		methods: c()({},
		n.i(u.a)(["tchatAddChannel", "tchatRemoveChannel"]), {
			scrollIntoViewIfNeeded: function () {
				var t = this;
				this.$nextTick(function () {
				...
				return a()(o.a.mark(function e() {
					...
					return o.a.wrap(function (e) {
						...
						case 7:
							...
							t.ignoreControls = !1,
							e.t0 = s.id,
							e.next = 1 === e.t0 ? 12 : 2 === e.t0 ? 14 : (e.t0, 16);
							break;
						case 12:
							return t.addChannelOption(),
							e.abrupt("break", 16);
						case 14:
							return t.removeChannelOption(),
							e.abrupt("break", 16);
						case 16:
						case "end":
							return e.stop()
			...
			onBack: function () { ! 0 !== this.ignoreControls && this.$router.push({
					name: "home"
				})
			},
				...
				return a()(o.a.mark(function e() {
					...
					return o.a.wrap(function (e) {
						...
						case 3:
							...
							s.length > 0 && (t.currentSelect = 0, t.tchatAddChannel({
								channel: s
							})),
							e.next = 11;
							break;
...
default = {
		...
		created: function () {
			this.useMouse ? this.currentSelect = -1 : (this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter), this.$bus.$on("keyUpBackspace", this.onBack)),
...
default = {
		...
		computed: o()({},
		n.i(i.b)(["IntlString", "contacts", "useMouse"])),
		methods: o()({},
		n.i(i.a)(["updateContact", "addContact"]), {
			onUp: function () {
			...
			save: function () { - 1 !== this.id ? this.updateContact({
					id: this.id,
			...
			deleteC: function () {
				...
				if ( - 1 !== this.id) {
					...
					c.a.CreateModal({
						...
						t.ignoreControls = !1,
						"Confirmar" === e.title && (t.$phoneAPI.deleteContact(t.id), history.back())
					})
				} else history.back()
			}
		}),
...
default = {
		...
		computed: a()({},
		n.i(r.b)(["IntlString","contacts","useMouse"]), {
			lcontacts: function () {
				return [{
					...
					return t.backgroundColor = t.backgroundColor || n.i(c.a)(t.number),
					t
				})))
			}
		}),
		methods: {
			onSelect: function (t) { - 1 === t.id ? this.$router.push({
					name: "contacts.view",
					params: {
						id: t.id
					}
			...
			back: function () { ! 0 !== this.disableList && this.$router.push({
					name: "home"
				})
			}
		},
...
default = {
		...
		computed: a()({},
		n.i(u.b)(["IntlString", "contacts", "useMouse"]), {
			lcontacts: function () {
				return [{
...
default = {
		...
		methods: l()({},
		n.i(p.a)(["setMessageRead", "sendMessage", "deleteMessage", "startCall"]), {
			...
			onEnter: function () {
				var t = this; ! 0 !== this.ignoreControls && ( - 1 !== this.selectMessage ? this.onActionMessage(this.messagesList[this.selectMessage]) : this.$phoneAPI.getReponseText().then(function (e) {
					var n = e.text.trim();
					"" !== n && t.sendMessage({
			...
			onSelectPhoneNumber: function (t) {
				...
				return c()(o.a.mark(function n() {
					...
					n, e, [[0, 33, 35, 39], [18, 29]])
				}))()
			},
			onBackspace: function () {
				if (void 0 !== this.imgZoom) return void(this.imgZoom = void 0); ! 0 !== this.ignoreControls && (!0 === this.useMouse && "BODY" !== document.activeElement.tagName || ( - 1 !== this.selectMessage ? this.selectMessage = -1 : this.quit()))
			},
		...
		computed: l()({},
		n.i(p.b)(["IntlString", "messages", "contacts", "useMouse", "enableTakePhoto"]), {
		...
		created: function () {
			...
			this.useMouse || (this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter), this.$bus.$on("keyUpArrowRight", this.onRight)),
			this.$bus.$on("keyUpBackspace", this.onBackspace)
		},
		beforeDestroy: function () {
			this.$bus.$off("keyUpArrowDown", this.onDown),
			...
			messagesData: function () {
				...
				s = t.reduce(function (t, s) {
					if (void 0 === t[s.transmitter]) {
						...
						void 0 !== i ? (o.display = i.display, o.backgroundColor = i.backgroundColor || n.i(c.a)(s.transmitter), o.letter = i.letter, o.icon = i.icon) : o.backgroundColor = n.i(c.a)(s.transmitter),
						t[s.transmitter] = o
					}
					return 0 === s.isRead && (t[s.transmitter].noRead += 1),
					s.time >= t[s.transmitter].lastMessage && (t[s.transmitter].lastMessage = s.time, t[s.transmitter].keyDesc = s.message),
					t
				},
				{}),
				i = [];
...
default = {
		...
		computed: l()({},
		n.i(p.b)(["IntlString", "useMouse", "myPhoneNumber", "backgroundLabel", "coqueLabel", "zoom", "config", "volume", "availableLanguages"]), {
			paramList: function () {
				var t = this.IntlString("CANCEL"),
				e = this.IntlString("Confirmar"),
				n = {},
				s = {};
				return n[t] = "cancel",
				s[e] = "accept",
		...
		methods: l()({},
		n.i(p.a)(["getIntlString", "setZoon", "setBackground", "setCoque", "setVolume", "setLanguage", "setMouseSupport"]), {
			scrollIntoViewIfNeeded: function () {
				this.$nextTick(function () {
					document.querySelector(".select").scrollIntoViewIfNeeded()
				})
			...
			onChangeBackground: function (t, e) {
				...
				return a()(o.a.mark(function t() {
					...
					return o.a.wrap(function (t) {
						...
						case 0:
							s = e.value,
							"URL" === s ? (n.ignoreControls = !0, d.a.CreateTextModal({
								text: "https://i.imgur.com/yOkfXTo.png"
							}).then(function (t) {
								"" !== t.text && void 0 !== t.text && null !== t.text && "https://i.imgur.com/yOkfXTo.png" !== t.text && n.setBackground({
									label: "Custom",
									value: t.text
								})
							}).
		...
		created: function () {
			this.useMouse ? this.currentSelect = -1 : (this.$bus.$on("keyUpArrowRight", this.onRight), this.$bus.$on("keyUpArrowLeft", this.onLeft), this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter)),
			this.$bus.$on("keyUpBackspace", this.onBackspace)
		},
		beforeDestroy: function () {
			this.$bus.$off("keyUpArrowRight", this.onRight),
...
default = {
		...
		computed: c()({},
		n.i(p.b)(["IntlString", "useMouse", "twitterUsername", "twitterPassword", "twitterAvatarUrl", "twitterNotification", "twitterNotificationSound"]), {
			isLogin: function () {
		...
		methods: c()({},
		n.i(p.a)(["twitterLogin", "twitterChangePassword", "twitterLogout", "twitterSetAvatar", "twitterCreateNewAccount", "setTwitterNotification", "setTwitterNotificationSound"]), {
			onUp: function () {
				if (!0 !== this.ignoreControls) {
					var t = document.querySelector(".group.select");
					if (null === t) return t = document.querySelector(".group"),
				...
				return a()(o.a.mark(function t() {
					...
					return o.a.wrap(function (t) {
						...
						case 0:
							...
							t.next = 3,
							h.a.CreateTextModal({
								text: e.twitterAvatarUrl || "https://i.imgur.com/yOkfXTo.png"
							});
						case 3:
							n = t.sent,
				...
				return a()(o.a.mark(function e() {
					...
					return o.a.wrap(function (e) {
						...
						case 0:
							...
							e.next = 3,
							h.a.CreateTextModal({
								text: t.twitterAvatarUrl || "https://i.imgur.com/yOkfXTo.png"
							});
						case 3:
							n = e.sent,
							t.twitterSetAvatar({
			...
			createAccount: function () { ! 0 === this.validAccount && (this.twitterCreateNewAccount(this.localAccount), this.localAccount = {
					username: "",
					password: "",
					passwordConfirm: "",
					avatarUrl: null
				...
				return a()(o.a.mark(function t() {
					...
					return o.a.wrap(function (t) {
						...
						case 16:
							...
							t.abrupt("return");
						case 19:
							e.twitterChangePassword(s.text),
							t.next = 25;
							break;
						case 22:
							t.prev = 22,
...
default = {
		...
		computed: c()({},
		n.i(u.b)(["IntlString", "useMouse"])),
		watch: {},
		methods: c()({},
		n.i(u.a)(["twitterPostTweet"]), {
			onEnter: function () {
				var t = this;
				return a()(o.a.mark(function e() {
					var n, s;
					return o.a.wrap(function (e) {
						...
						case 3:
							n = e.sent,
							void 0 !== n && void 0 !== n.text && (s = n.text.trim(), 0 !== s.length && t.twitterPostTweet({
								message: s
							})),
							e.next = 9;
							break;
		...
		created: function () {
			this.useMouse || this.$bus.$on("keyUpEnter", this.onEnter),
			this.$bus.$on("keyUpBackspace", this.onBack)
		},
		mounted: function () {
			var t = this;
...
default = {
		...
		computed: l()({},
		n.i(p.b)(["favoriteTweets", "IntlString", "useMouse"]), {
			tweets: function () {
		...
		watch: {},
		methods: l()({},
		n.i(p.a)(["twitterLogin", "twitterPostTweet", "twitterToogleLike", "fetchFavoriteTweets"]), {
			showOption: function () {
				var t = this;
				return c()(o.a.mark(function e() {
					var n, s, i;
					return o.a.wrap(function (e) {
						...
						case 6:
							...
							t.ignoreControls = !1,
							e.t0 = i.id,
							e.next = 1 === e.t0 ? 11 : 2 === e.t0 ? 13 : 3 === e.t0 ? 15 : 17;
							break;
						case 11:
			...
			reply: function (t) {
				...
				return c()(o.a.mark(function n() {
					...
					return o.a.wrap(function (n) {
						...
						case 5:
							i = n.sent,
							void 0 !== i && void 0 !== i.text && (a = i.text.trim(), 0 !== a.length && e.twitterPostTweet({
								message: a
							})),
							n.next = 11;
							break;
			...
			onBack: function () {
				if (void 0 !== this.imgZoom) return void(this.imgZoom = void 0); ! 0 !== this.ignoreControls && ( - 1 !== this.selectMessage ? this.selectMessage = -1 : (this.$bus.$emit("twitterHome")))
			},
			formatTime: function (t) {
				return new Date(t).toLocaleTimeString()
			}
		...
		created: function () {
			this.useMouse || (this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter)),
			this.$bus.$on("keyUpBackspace", this.onBack)
		},
		mounted: function () {
...
default = {
		...
		computed: l()({},
		n.i(p.b)(["tweets", "IntlString", "useMouse"])),
		watch: {},
		methods: l()({},
		n.i(p.a)(["twitterLogin", "twitterPostTweet", "twitterToogleLike", "fetchTweets"]), {
			showOption: function () {
				var t = this;
				return c()(o.a.mark(function e() {
					var n, s, i;
			...
			onBack: function () {
				if (void 0 !== this.imgZoom) return void(this.imgZoom = void 0); ! 0 !== this.ignoreControls && ( - 1 !== this.selectMessage ? this.selectMessage = -1 : this.$router.push({
					name: "home"
				}))
			},
			formatTime: function (t) {
	...
	t.exports = {
		render: function () {
			...
			t._l(t.tweets, function (e, s) {
				...
				[n("img", {
					attrs: {
						src: e.authorIcon || "https://i.imgur.com/yOkfXTo.png",
						width: "48",
						height: "48"
					}
				})]), t._v(" "), n("div", {
