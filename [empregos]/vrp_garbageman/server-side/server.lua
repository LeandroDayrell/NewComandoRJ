...
function garbageMakeList(status)
	garbageList = {
		...
		[691] = { 807.84,-759.56,26.79 },
		[692] = { 805.85,-759.71,26.79 },
		[693] = { 803.95,-759.51,26.79 },
		[694] = { 796.98,-759.71,26.86 },
		[695] = { 758.28,-882.88,25.12 },
		[696] = { 793.13,-904.38,25.21 },
		[697] = { 761.59,-923.88,25.36 },
		[698] = { 748.58,-973.98,24.76 },
		[699] = { 742.51,-978.09,24.71 },
		[700] = { 750.03,-986.72,24.99 },
		[701] = { 739.68,-988.13,24.58 },
		[702] = { 725.34,-992.68,23.95 },
		[703] = { 698.88,-978.06,24.11 },
		[704] = { 799.3,-981.37,26.15 },
		[705] = { 799.28,-979.64,26.15 },	
		[706] = { 813.24,-1013.27,26.24 },
		[707] = { 827.06,-1055.16,27.95 },
		[708] = { 827.45,-1062.04,27.95 },
		[709] = { 827.27,-1064.42,27.99 },
		[710] = { 820.39,-1076.01,28.36 },
		[711] = { 879.66,-1076.59,29.66 },
		[712] = { 867.98,-1053.55,29.54 },
		[713] = { 864.4,-1053.85,29.32 },
		[714] = { 780.2,-1092.44,28.56 },
		[715] = { 870.4,-1140.8,24.17 },
		[716] = { 870.25,-1143.53,24.27 },
		[717] = { 857.16,-1159.68,25.15 },
		[718] = { 830.7,-1163.94,25.27 },
		[719] = { 830.68,-1169.49,25.27 },
	}
...
function cRP.paymentMethod(garbageId)
	...
	if user_id then
		...
		if parseInt(random) >= 81 then
			vRP.giveInventoryItem(user_id,"plastic",math.random(5,12),true)
		elseif parseInt(random) >= 61 and parseInt(random) <= 80 then
			vRP.giveInventoryItem(user_id,"glass",math.random(5,12),true)
		elseif parseInt(random) >= 41 and parseInt(random) <= 60 then
			vRP.giveInventoryItem(user_id,"rubber",math.random(5,12),true)
		elseif parseInt(random) >= 26 and parseInt(random) <= 40 then
			vRP.giveInventoryItem(user_id,"aluminum",math.random(7,17),true)
		elseif parseInt(random) >= 0 and parseInt(random) <= 25 then
			vRP.giveInventoryItem(user_id,"copper",math.random(5,15),true)
		end
