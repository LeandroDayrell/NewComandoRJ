...
local blips = {
	...
	{ -491.37,-339.8,42.33,403,3,"Farmácia",0.7 },
	...
	{ 83.6,277.1,120.33,78,5,"McDonalds",0.4 },
...
-----------------------------------------------------------------------------------------------------------------------------------------
  Citizen.CreateThread(function()
	while true do
		...
		N_0x4757f00bc6323cfe(GetHashKey("WEAPON_PISTOL_MK2"),0.8)
		...
		N_0x4757f00bc6323cfe(GetHashKey("WEAPON_SPECIALCARBINE"),1.6)
		N_0x4757f00bc6323cfe(GetHashKey("WEAPON_SPECIALCARBINE_MK2"),1.7)
		N_0x4757f00bc6323cfe(GetHashKey("WEAPON_ASSAULTRIFLE"),1.4)
		N_0x4757f00bc6323cfe(GetHashKey("WEAPON_ASSAULTRIFLE_MK2"),1.5)
...
local teleport = {
	...
	{ 136.33,-762.05,45.76,2154.71,2921.06,-81.07,"ENTRAR" }, -- IRMANDADE
	{ 2154.71,2921.06,-81.07,136.33,-762.05,45.76,"SAIR" },-- IRMANDADE
}
