...
function cRP.toggleHandcuff()
	...
	if not handcuff then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			SetPedComponentVariation(ped,7,91,0,2)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			SetPedComponentVariation(ped,7,75,0,2)
		end
	else
		handcuff = false
...
local disService = {
	...
	{ 907.99,-161.15,74.14,"Taxista" }, -- DP
	{ -1072.37,-824.45,5.48,"Police" }, -- DP

	{ -430.87,-324.83,34.92,"SamuEnfermeiro" }, -- Hosp
	{ -430.87,-324.83,34.92,"SamuMedico" }, -- Hosp
	{ -430.87,-324.83,34.92,"SamuCoordenador" }, -- Hosp
	{ -430.87,-324.83,34.92,"SamuViceDiretor" }, -- Hosp
	{ -430.87,-324.83,34.92,"SamuDiretor" }, -- Hosp
}
------------------------------------------------------------------------------------------------------------------------------------------
-- DISTANCESERVICE
-----------------------------------------------------------------------------------------------------------------------------------------
