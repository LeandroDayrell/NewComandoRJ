...
local labels = {        
	{ "REDNECK_AMBO_HELP", "Pressione ~INPUT_CONTEXT~ para abrir/fechar portas de tras.~n~Pressione ~INPUT_HUD_SPECIAL~ para estender o suporte da maca." },
	{ "REDNECK_AMBO_HELP2", "Pressione ~INPUT_CONTEXT~ para abrir/fechar portas de tras.~n~Pressione ~INPUT_DETONATE~ para pegar a maca.~n~Press ~INPUT_HUD_SPECIAL~ para estender o suporte da maca." },
	{ "REDNECK_AMBO_HELP3", "Pressione ~INPUT_CONTEXT~ para abrir/fechar portas de tras.~n~Pressione ~INPUT_DETONATE~ para fixar a maca.~n~Press ~INPUT_HUD_SPECIAL~ para estender o suporte da maca." }
}
