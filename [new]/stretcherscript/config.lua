...
Config.Language = {
    ...
    do_action = 'Pressione ~INPUT_CONTEXT~ interagir com a maca',
    take_bed = "Pressione ~INPUT_CONTEXT~ para pegar a maca",
    release_bed = "Pressione ~INPUT_SPECIAL_ABILITY_SECONDARY~ para soltar a maca",
    in_vehicle_bed = "Pressione ~INPUT_CONTEXT~ para colocar a maca na ambulância",
    out_vehicle_bed = "Pressione ~INPUT_CONTEXT~ para retirar a maca da ambulância",
    go_out_bed = "Sair da maca",
    delete_bed = "Guardar a maca",
    ...
    anim = {
        ...
        sit_right = "Sentar do lado direito",
        sit_left = "Sentar do lado esquerdo",
        convulse = "Receber CPR",
        pls = "Deite de lado",
    }
}